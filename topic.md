"1. Chủ đề Ứng dụng Deep Reinforcement Learning để tối ưu hóa điều phối tác vụ trong hệ thống Hybrid Edge-Cloud.
2. Nội dung thực hiện dự kiến
...
Phát triển bộ điều phối thông minh (Smart Dispatcher): Viết script Python đóng vai trò ""trung tâm điều khiển"", có nhiệm vụ đọc dữ liệu thời gian thực từ Prometheus, nạp mô hình AI đã huấn luyện và thực hiện điều hướng task tới node tối ưu nhất.
